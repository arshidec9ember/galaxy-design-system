...
You can directly import components from Galaxy Design Components or install it globally to a Vue app.
...
import ZetaGalaxyComponents from '@zeta-gds/components'
...
// tsconfig.json
{
  "compilerOptions": {
    // ...
    "types": ["@zeta-gds/components/volar"]
  }
}
```
