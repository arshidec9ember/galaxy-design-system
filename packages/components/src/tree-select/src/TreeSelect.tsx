...
export const treeSelectProps = {
  ...
  renderOptionTag: Function as PropType<TreeSelectRenderTag>,
  ...treeSharedProps,
  renderOptionLabel: Function as PropType<TreeSelectRenderLabel>,
  renderOptionStart: Function as PropType<TreeSelectRenderPrefix>,
  renderOptionEnd: Function as PropType<TreeSelectRenderSuffix>,
...
export default defineComponent({
  ...
  setup (props) {
    ...
    const uncontrolledValueRef = ref<Value>(props.defaultModelValue)
    ...
    const uncontrolledExpandedKeysRef = ref(
      props.defaultExpandAll
        ? undefined // leave it, z-tree will handle it
    ...
    function doUpdateValue (
      ...
      if (onUpdateModelValue) {
        call(onUpdateModelValue as OnUpdateModelValueImpl, value, option, meta)
      }
      if (_onUpdateModelValue) {
        call(_onUpdateModelValue as OnUpdateModelValueImpl, value, option, meta)
      }
    ...
    function handleMenuClickoutside (e: MouseEvent): void {
      if (menuElRef.value?.contains(getPreciseEventTarget(e) as Node | null)) {
        return
      }
    ...
    const selectionRenderTagRef = computed(() => {
      const { renderOptionTag } = props
      if (!renderOptionTag) return undefined
      return function selectionRenderTag ({
        ...
        if (value !== undefined) {
          ...
          if (treeOption) {
            return renderOptionTag({ option: treeOption.rawNode, handleClose })
          }
        }
        return value
      }
    ...
    const cssVarsRef = computed(() => {
      ...
      return {
        ...
        '--z-menu-border-radius': menuBorderRadius,
        '--z-menu-color': menuColor,
        '--z-menu-height': menuHeight,
                          ...
                          return withDirectives(
                            ...
                            >
                              <ZTree
                                ...
                                renderOptionStart={this.renderOptionStart}
                                renderOptionEnd={this.renderOptionEnd}
                                renderOptionExpandIcon={
                                  this.renderOptionExpandIcon
                                }
                              ...
                              <ZBaseFocusDetector onFocus={this.handleTabOut} />
                            </div>,
                            [
                              [
                                clickoutside,
