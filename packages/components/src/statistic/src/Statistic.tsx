  ...
  setup (props) {
    ...
    const cssVarsRef = computed(() => {
      ...
      return {
        ...
        '--z-value-font-weight': valueFontWeight,
        '--z-value-font-size': valueFontSize,
        '--z-value-prefix-text-color': valuePrefixTextColor,
        '--z-value-suffix-text-color': valueSuffixTextColor,
