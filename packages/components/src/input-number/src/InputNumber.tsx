...
import type { OnUpdateModelValue, InputNumberInst, Size } from './interface'
...
export const inputNumberProps = {
  ...
  buttonPlacement: {
    type: String as PropType<'end' | 'both'>,
    default: 'end'
  },
  readonly: Boolean,
  clearable: Boolean,
    ...
    return (
      ...
      >
        <ZInput
          ...
          modelValue={this.displayedValue}
          onUpdateModelValue={this.handleUpdateDisplayedValue}
            ...
            suffix: () =>
              this.showButton
                ? [
                    ...
                    this.buttonPlacement === 'end' ? renderMinusButton() : null,
                    renderAddButton()
                  ]
                : $slots.suffix?.()
          }}
