...
const derived: ThemeCommonVars = {
  ...
  infoColorFocus: base.primaryActive,
  // success color
  successColor: base.successDefault,
  successColorHover: base.successHover,
  successColorPressed: base.successActive,
  successColorSuppl: base.successSuppl,
  successColorFocus: base.primaryActive,
  // warning color
  warningColor: base.warningDefault,
  warningColorHover: base.warningHover,
  warningColorPressed: base.warningActive,
  warningColorSuppl: base.warningSuppl,
  warningColorFocus: base.primaryActive,
  // error color
  errorColor: base.errorDefault,
  errorColorHover: base.errorHover,
  errorColorPressed: base.errorActive,
  errorColorSuppl: base.errorSuppl,
  errorColorFocus: base.primaryActive,
  // text color
  ...
  // new tab icon
  newTabIconColor: overlay(Number(base.alphaClose)),
  newTabIconColorHover: overlay(Number(base.alphaClose)),
  newTabIconColorPressed: overlay(Number(base.alphaClose)),
  newTabColorHover: 'rgba(255, 255, 255, .12)',
  newTabColorPressed: 'rgba(255, 255, 255, .08)',
  ...
  toggleColorHover: 'rgba(255, 255, 255, .12)',
  toggleColorPressed: 'rgba(255, 255, 255, .08)',
  ...
  inputBackgroundColor: '#F6F7FA',
  inputBorderColor: '#7D83A6',
