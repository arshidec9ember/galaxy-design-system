  ...
  `, [
    ...
    `, [
      ...
      `, [
        ...
        cM('down-scroll', {
          animation: 'z-base-slot-machine-fade-down-out .2s cubic-bezier(0, 0, .2, 1)',
          animationIterationCount: 1
        }),
        cM('up-scroll', {
          animation: 'z-base-slot-machine-fade-up-out .2s cubic-bezier(0, 0, .2, 1)',
          animationIterationCount: 1
        })
      ]),
      ...
      `, [
        cM('down-scroll', {
          animation: 'z-base-slot-machine-fade-down-in .2s cubic-bezier(0, 0, .2, 1)',
          animationIterationCount: 1
        }),
        cM('up-scroll', {
          animation: 'z-base-slot-machine-fade-up-in .2s cubic-bezier(0, 0, .2, 1)',
          animationIterationCount: 1
        }),
        cE('inner', `
            display: inline-block;
