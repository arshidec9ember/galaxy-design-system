...
import { useIsIos } from '../../../_external-dependencies/vooks'
...
const Scrollbar = defineComponent({
  ...
  setup (props) {
    ...
    function handleScroll (e: Event): void {
      ...
      if (container) {
        isScrolled.value = container.scrollTop > 0
      }
    ...
    const cssVarsRef = computed(() => {
      const {
        ...
        self: { color, colorHover, scrollBoxShadowColor }
      } = themeRef.value
      return {
        '--z-scrollbar-bezier': cubicBezierEaseInOut,
        '--z-scrollbar-color': color,
        '--z-scrollbar-color-hover': colorHover,
        '--z-scrollbar-border-radius': scrollbarBorderRadius,
        '--z-scrollbar-width': scrollbarWidth,
        '--z-scrollbar-height': scrollbarHeight,
        '--z-scrollbar-box-shadow-color': scrollBoxShadowColor
      }
    })
