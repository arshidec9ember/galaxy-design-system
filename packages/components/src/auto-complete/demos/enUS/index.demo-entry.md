...
| default-model-value | `string` | `null` | Default value of autocomplete. |  |
...
| model-value | `string` | `undefined` | Input of autocomplete. |  |
...
| on-update:model-value | `(value: string \| null) => void` | `undefined` | On update callback function. |  |
