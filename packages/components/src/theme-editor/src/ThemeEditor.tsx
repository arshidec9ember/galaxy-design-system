...
import { type PopoverPlacement, ZPopover } from '../../popover'
import { ZAccordion, ZAccordionItem } from '../../accordion'
import { ZInput } from '../../input'
import { ZSpace } from '../../space'
import { ZGrid, ZGi } from '../../grid'
...
export default defineComponent({
  ...
  setup () {
    ...
    const theme = computed(() => {
      const mergedTheme: GlobalTheme =
        ZConfigProvider?.mergedThemeRef.value || lightTheme
    ...
    const themeCommonDefaultRef = computed(() => {
      return ZConfigProvider?.mergedThemeRef.value?.common || lightTheme.common
    })
    const showPanelRef = ref(false)
    const overridesRef = ref<any>(
      JSON.parse(localStorage['zeta-gds-theme-overrides'] || '{}')
    )
    ...
    function handleExportClick (): void {
      ...
      a.href = url
      a.download = 'zeta-gds-theme-overrides.json'
    ...
    watch(overridesRef, (value) => {
      localStorage['zeta-gds-theme-overrides'] = JSON.stringify(value)
    })
    return {
  ...
  render () {
    return (
      <ZConfigProvider themeOverrides={this.overrides}>
        {{
          default: () => [
            <ZPopover
              scrollable
                      ...
                      {{
                        default: () => [
                          ...
                          <ZInput
                            ...
                            modelValue={this.tempCompNamePattern}
                          ...
                          <ZInput
                            ...
                            modelValue={this.tempVarNamePattern}
                      ...
                      {{
                        default: () => {
                          ...
                          if (!filteredItemsCount) {
                            return <ZEmpty showDescription={false} />
                          }
