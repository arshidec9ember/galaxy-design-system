...
import { type VirtualListInst } from '../../_external-dependencies/vueuc'
import type { ZLocale, ZDateLocale } from '../../locales'
...
export type DatePickerInjection = {
  ...
  >
  localeRef: Ref<ZLocale['DatePicker']>
...
export const datePickerInjectionKey =
  createInjectionKey<DatePickerInjection>('z-date-picker')
