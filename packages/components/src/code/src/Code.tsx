...
export const codeProps = {
  ...
  // In z-log, we only need to mount code's style for highlight
...
export default defineComponent({
  ...
  setup (props, { slots }) {
    ...
    const cssVarsRef = computed(() => {
      ...
      return {
        '--z-font-size': internalFontSize ? `${internalFontSize}px` : fontSize,
        ...
        '--z-hue-6': $8,
        '--z-hue-6-2': $9,
        '--z-line-number-text-color': lineNumberTextColor,
