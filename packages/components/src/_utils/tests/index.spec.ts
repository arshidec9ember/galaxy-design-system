...
describe('vue', () => {
  ...
  it('should work with createDataKey', () => {
    expect(createDataKey('1')).toBe('str-1')
    expect(createDataKey(1)).toBe('num-1')
  })
