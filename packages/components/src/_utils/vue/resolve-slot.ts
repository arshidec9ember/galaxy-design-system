...
/**
 * Resolve slot with child for optimized rendering, no fallback
 */
export const resolveChildSlot = (slot: Slot | undefined): VNodeChild => {
  return resolveWrappedSlot(slot, (children) => {
    return children
  })
}
