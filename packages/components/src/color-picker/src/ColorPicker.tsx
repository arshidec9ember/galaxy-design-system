...
import { createKey, useAdjustedTo } from '../../_utils'
...
export const colorPickerProps = {
  ...
  defaultShow: Boolean,
  defaultModelValue: String as PropType<string | null>,
  modes: {
  ...
  onComplete: Function as PropType<OnUpdateModelValue>,
  onConfirm: Function as PropType<OnUpdateModelValue>,
  ...
  setup (props, { slots }) {
    ...
    function handleComplete (pushStack: boolean = true): void {
      ...
      if (value) {
        ...
        if (onComplete) {
          ;(onComplete as OnUpdateModelValueImpl)(value)
        }
    ...
    const cssVarsRef = computed(() => {
      ...
      return {
        ...
        '--z-color': color,
        '--z-panel-font-size': panelFontSize,
