...
export function self (vars: ThemeCommonVars) {
  ...
  return {
    ...
    ...createPartialInvertedVars('#fff', '#fff', '#fff', '#fff')
  }
}
...
export function createPartialInvertedVars (
  ...
  return {
    titleTextColorInverted: color,
    backColorInverted: color,
    backColorHoverInverted: activeItemColor,
    backColorPressedInverted: activeTextColor,
    descriptionTextColorInverted: groupTextColor
  }
}
