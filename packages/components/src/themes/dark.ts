...
import { backToTopDark } from '../back-to-top/styles'
...
import { jsonViewerDark } from '../json-viewer/styles'
import { accordionDark } from '../accordion/styles'
...
import { dataTableSettingsDark } from '../data-table-settings/styles'
import { datePickerDark } from '../date-picker/styles'
import { detailsDark } from '../details/styles'
import { detailsViewDark } from '../detail-view/styles'
...
import { textEditorDark } from '../text-editor/styles'
...
import { ratingDark } from '../rating/styles'
import { resultDark } from '../result/styles'
import { rowDark } from '../row-column/styles'
...
import { spinnerDark } from '../spinner/styles'
import { statisticDark } from '../statistic/styles'
import { stepperDark } from '../stepper/styles'
import { superDatePickerDark } from '../super-date-picker/styles'
import { switchDark } from '../switch/styles'
import { panelDark } from '../panel/styles'
import { tableDark } from '../table/styles'
import { tabsDark } from '../tabs/styles'
import { tagDark } from '../tag/styles'
import { facadeDark } from '../facade/styles'
...
import { linkDark } from '../link/styles'
import { cardStandardDark } from '../card-standard/styles'
import { filterDark } from '../filter/styles'
...
export const darkTheme: BuiltInGlobalTheme = {
  ...
  Stepper: stepperDark,
  SuperDatePicker: superDatePickerDark,
  Switch: switchDark,
  Panel: panelDark,
  Table: tableDark,
  Tabs: tabsDark,
