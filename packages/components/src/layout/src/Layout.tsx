...
export const layoutInjectionKey =
  createInjectionKey<ExtractPropTypes<typeof layoutProps>>('z-layout')
  ...
  return defineComponent({
    ...
    setup (props) {
      ...
      const cssVarsRef = computed(() => {
        ...
        // FIXME: add embedded effect for card or discuss if it needs to get removed.
        return {
          '--z-bezier': cubicBezierEaseInOut,
          '--z-color': props.embedded ? self.colorEmbedded : self.color,
          '--z-text-color': self.textColor
        }
      })
