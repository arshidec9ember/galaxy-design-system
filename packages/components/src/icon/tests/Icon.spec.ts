...
describe('z-icon', () => {
  ...
  it('should work with `size` prop', async () => {
    const wrapper = mount(ZIcon, { props: { size: 40 } })
    expect(wrapper.find('[role="img"]').classes()).toContain('z-icon')
  ...
  it('should work with `color` prop', async () => {
    const wrapper = mount(ZIcon, { props: { color: 'rgb(14, 122, 13)' } })
    expect(wrapper.find('[role="img"]').attributes('style')).toContain(
      'color: rgb(14, 122, 13);'
    )
    wrapper.unmount()
  ...
  it('should work with `opacity` prop', async () => {
    const wrapper = mount(ZIcon, { props: { opacity: 5 } })
    expect(wrapper.find('[role="img"]').classes()).toContain('z-icon--opacity')
  ...
  it('should work with customize icon', async () => {
    ...
    const wrapper = mount(ZIcon, { slots: { default: () => customize } })
