...
export default defineComponent({
  ...
  setup (props) {
    ...
    function handleKeyboard (e: KeyboardEvent): void {
      ...
      const vertical = ZCarousel.isVertical()
      ...
      e.preventDefault()
      if (wantToNext && !ZCarousel.isNextDisabled()) {
        ZCarousel.next()
        focusDot(ZCarousel.currentIndexRef.value)
      } else if (wantToPrev && !ZCarousel.isPrevDisabled()) {
        ZCarousel.prev()
        focusDot(ZCarousel.currentIndexRef.value)
      }
    }
