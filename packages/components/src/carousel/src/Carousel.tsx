...
import ZCarouselDots from './CarouselDots'
import ZCarouselArrow from './CarouselArrow'
import ZCarouselItem, { isCarouselItem } from './CarouselItem'
import type {
  ...
  setup (props) {
    ...
    const cssVarsRef = computed(() => {
      ...
      return {
        ...
        '--z-dot-color-focus': dotColorFocus,
        '--z-dot-color-active': dotColorActive,
        '--z-dot-size': dotSize,
        '--z-dot-line-width': dotLineWidth,
        '--z-dot-line-width-active': dotLineWidthActive,
