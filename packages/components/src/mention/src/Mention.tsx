...
export const mentionProps = {
  ...
  MaybeArray<(show: boolean) => void>
  >,
  'onUpdate:modelValue': [Array, Function] as PropType<
  MaybeArray<(value: string) => void>
  >,
  onUpdateModelValue: [Array, Function] as PropType<
  MaybeArray<(value: string) => void>
  >,
    ...
    return (
      <div class={`${mergedClsPrefix}-mention`}>
        <ZInput
          ...
          onUpdateModelValue={this.handleInputUpdateValue}
          onKeydown={this.handleInputKeyDown}
          onFocus={this.handleInputFocus}
          onBlur={this.handleInputBlur}
          bordered={this.mergedBordered}
          disabled={this.disabled}
          modelValue={this.mergedValue}
        />
        <VBinder>
          {{
            default: () => [
