...
import { onFontsReady } from '../../_external-dependencies/vooks'
import { ZScrollbar } from '../../_internal'
import { keysOf } from '../../_utils'
import { useRootInstance } from '../../_mixins'
...
export default defineComponent({
  ...
  setup (props) {
    const shadowRootRef = useRootInstance()
    ...
    function setActiveHref (href: string, transition = true): void {
      ...
      const linkEl = shadowRootRef.value.getElementById(idMatchResult[1])
      if (!linkEl) return
  ...
  render () {
    ...
    const Anchor = (
      <div
        ...
        ref="selfRef"
      >
        {/* TODO: find use case of the following */}
