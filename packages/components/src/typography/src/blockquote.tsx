  ...
  setup (props) {
    ...
    const cssVarsRef = computed(() => {
      ...
      return {
        ...
        '--z-font-size': blockquoteFontSize,
        '--z-line-height': blockquoteLineHeight,
        '--z-prefix-color': blockquotePrefixColor,
        '--z-text-color': blockquoteTextColor
      }
    })
    ...
    return (
      <blockquote
        class={[
          ...
          this.themeClass,
          this.indent && `${mergedClsPrefix}-blockquote--indent`
        ]}
