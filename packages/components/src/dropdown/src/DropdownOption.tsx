...
export interface ZDropdownOptionInjection {
...
export default defineComponent({
  ...
  setup (props) {
    ...
    const ZDropdown = inject(dropdownInjectionKey)!
    const {
      hoverKeyRef,
      keyboardKeyRef,
    ...
    const ZDropdownOption = inject(dropdownOptionInjectionKey, null)
    // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
    const ZDropdownMenu = inject(dropdownMenuInjectionKey)!
    // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
    const ZPopoverBody = inject(popoverBodyInjectionKey)!
    ...
    const parentEnteringSubmenuRef = computed(() => {
      return !!ZDropdownOption?.enteringSubmenuRef.value
    })
    ...
    return {
      ...
      siblingHasIcon: ZDropdownMenu.showIconRef,
      siblingHasSubmenu: ZDropdownMenu.hasSubmenuRef,
      menuProps: menuPropsRef,
      popoverBody: ZPopoverBody,
