...
import { warn, throwError, useRootNode } from '../../_utils'
...
import ZUploadFileList from './UploadFileList'
...
export default defineComponent({
  ...
  setup (props) {
    ...
    const controlledFileListRef = useProxyModel(props, 'fileList')
    ...
    function doUpdateFileList (files: SettledFileInfo[]): void {
      controlledFileListRef.value = files
    ...
    const cssVarsRef = computed(() => {
      ...
      return {
        ...
        '--z-trash-icon-color': trashIconColor,
        '--z-uploader-border-color': uploaderBorderColor,
        '--z-download-text-color': downloadTextColor,
        '--z-border-radius': borderRadius,
        '--z-uploader-list-border-radius': uploaderListBorderRadius,
        '--z-dragger-border': draggerBorder,
        '--z-dragger-border-hover': draggerBorderHover,
        '--z-dragger-color': draggerColor,
        '--z-font-size': fontSize,
        '--z-item-color-hover': itemColorHover,
        '--z-item-color-hover-error': itemColorHoverError,
        '--z-item-disabled-opacity': itemDisabledOpacity,
        '--z-item-icon-color': itemIconColor,
        '--z-item-text-color': itemTextColor,
        '--z-item-text-color-error': itemTextColorError,
        '--z-item-text-color-success': itemTextColorSuccess,
        '--z-line-height': lineHeight,
        '--z-item-border-image-card-error': itemBorderImageCardError,
        '--z-item-border-image-card': itemBorderImageCard
      } as any
    })
  ...
  render () {
    ...
    if (this.abstract) {
      return (
        <>
          {$slots.default?.()}
          <Teleport to={this.root}>{inputNode}</Teleport>
        </>
      )
    }
    ...
    return (
      ...
      >
        ...
        {this.showFileList && <ZUploadFileList>{$slots}</ZUploadFileList>}
      </div>
    )
  }
})
