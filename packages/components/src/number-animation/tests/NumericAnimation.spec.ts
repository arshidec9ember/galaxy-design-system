...
import { ZNumberAnimation } from '../index'

describe('z-number-animation', () => {
  it('should work with import on demand', () => {
    mount(ZNumberAnimation)
  })

  it('should work with `to` prop', async () => {
    const wrapper = mount(ZNumberAnimation, {
  ...
  it('should work with `active` prop', async () => {
    let wrapper = mount(ZNumberAnimation, {
    ...
    wrapper = mount(ZNumberAnimation, {
      props: { to: 110, from: 10, active: false }
    })
