  ...
  `, [
    ...
    `, [
      ...
      cB('legacy-transfer-list-header', `
        height: calc(var(--z-item-height) + 4px);
        ...
        background-color: var(--z-header-color);
        transition:
      ...
      `, [
        cB('legacy-transfer-filter', `
          ...
          transition:
            border-color .3s var(--z-bezier),
            background-color .3s var(--z-bezier);
          border-bottom: 1px solid var(--z-filter-divider-color);
        `),
        ...
        `, [
          ...
          `, [
            ...
            `, [
              cNotM('disabled', [
                c('&:hover', {
                  backgroundColor: 'var(--z-item-color-pending)'
                })
              ]),
              cE('extra', `
              ...
              cM('source', {
                ...
                c('&.item-enter-active', `
                  ...
                  animation-timing-function: var(--z-bezier), var(--z-bezier-ease-out);
                ...
                c('&.item-leave-active', `
                  transform: translateX(-150%);
                  animation-duration: .25s, .25s;
                  animation-timing-function: var(--z-bezier), var(--z-bezier-ease-in);
