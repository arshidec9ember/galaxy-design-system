...
import { LazyTeleport } from '../../_external-dependencies/vueuc'
  ...
  setup (props) {
    ...
    const cssVarsRef = computed(() => {
      ...
      return {
        ...
        '--z-toolbar-icon-color': toolbarIconColor,
        '--z-toolbar-color': toolbarColor,
        '--z-toolbar-border-radius': toolbarBorderRadius,
        '--z-toolbar-box-shadow': toolbarBoxShadow
      }
    })
