...
export default defineComponent({
  ...
  setup (props) {
    ...
    const ZTab = inject(tabsInjectionKey, null)
    if (!ZTab) {
      throwError('tab-pane', '`z-tab-pane` must be placed inside `z-tabs`.')
    }
    return {
      style: ZTab.paneStyleRef,
      class: ZTab.paneClassRef,
      mergedClsPrefix: ZTab.mergedClsPrefixRef
    }
  },
  render () {
    return (
