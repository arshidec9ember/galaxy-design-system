...
import { ZInternalSelection } from '../../_internal'
...
export const cascaderProps = {
  ...
  renderOptionLabel: Function as PropType<
...
export default defineComponent({
  ...
  setup (props, { slots }) {
    ...
    function doUpdateValue (
      ...
      if (onChange) {
        call(onChange as OnUpdateModelValueImpl, value, option, optionPath)
      }
    ...
    function handleCascaderMenuClickOutside (e: MouseEvent): void {
      if (
        cascaderMenuInstRef.value?.$el.contains(
    ...
    const cssVarsRef = computed(() => {
      ...
      return {
        ...
        '--z-column-width': columnWidth,
        '--z-menu-color': menuColor,
        '--z-menu-divider-color': menuDividerColor,
        '--z-option-height': optionHeight,
        '--z-option-font-size': optionFontSize,
        ...
        '--z-option-color-hover': optionColorHover,
        '--z-option-check-mark-color': optionCheckMarkColor,
        '--z-option-arrow-color': optionArrowColor,
        '--z-menu-mask-color': changeColor(menuColor, { alpha: 0.75 }),
