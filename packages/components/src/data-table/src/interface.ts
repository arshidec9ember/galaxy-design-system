...
export const dataTableProps = {
  ...
  >,
  renderRowExpandIcon: Function as PropType<RenderExpandIcon>,
  spinnerProps: {
...
export interface CommonColumnInfo<T = InternalRowData> {
  ...
  description?: string | ((column: TableColumn<T>) => VNodeChild)
  icon?: () => VNodeChild
}
...
export type TableColumnGroup<T = InternalRowData> = {
  ...
  resizable?: boolean
  filterOptions?: never
  description?: string | ((column: TableBaseColumn) => VNodeChild)
  icon?: () => VNodeChild
} & CommonColumnInfo<T>
...
export type TableSelectionColumn<T = InternalRowData> = {
  ...
  key?: ColumnKey
  title?: string | TableExpandColumnTitle
  visible?: boolean
  sorter?: never
  resizable?: boolean
  filter?: never
...
export interface DataTableInjection {
  ...
  localeRef: Ref<ZLocale['DataTable']>
...
export const dataTableInjectionKey =
  createInjectionKey<DataTableInjection>('z-data-table')
