...
<z-space vertical :size="12">
  <z-space>
    <z-button @click="sortName('ascend')">Sort By Name (Ascend)</z-button>
    <z-button @click="sortName('descend')">Sort By Name (Descend)</z-button>
    <z-button @click="clearSorter">Clear Sorter</z-button>
  </z-space>
  <z-data-table
    :columns="columns"
    :data="data"
