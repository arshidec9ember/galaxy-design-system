...
export const self = (vars: ThemeCommonVars) => {
  ...
  return {
    ...
    thDescriptionTextColor: textColor2,
    tdColorDisabled: cardColor,
    tdColor: cardColor,
    ...
    trBackgroundColorSelected: composite(
      composite(cardColor, tableHeaderColor),
      tableColorHover
    ),
    // modal
    ...
    boxShadowExpanded: 'inset 0px 1px 1px 0px #E6E7F2',
    expandedBackgroundColor: '#f9fafc',
    // loading
