...
import { on, off } from '../../_external-dependencies/evtd'
import {
  useTheme,
  useFormItem,
  useConfig,
  ...
  setup (props) {
    ...
    const cssVarsRef = computed(() => {
      ...
      return {
        ...
        '--z-dot-border': dotBorder,
        '--z-dot-border-active': dotBorderActive,
        '--z-dot-border-radius': dotBorderRadius,
        '--z-dot-box-shadow': dotBoxShadow,
        '--z-dot-color': dotColor,
        '--z-dot-color-modal': dotColorModal,
        '--z-dot-color-popover': dotColorPopover,
        '--z-dot-height': dotHeight,
        '--z-dot-width': dotWidth,
        '--z-fill-color': fillColor,
        '--z-fill-color-hover': fillColorHover,
        '--z-font-size': fontSize,
        '--z-handle-box-shadow': handleBoxShadow,
        '--z-handle-box-shadow-active': handleBoxShadowActive,
        '--z-handle-box-shadow-focus': handleBoxShadowFocus,
        '--z-handle-box-shadow-hover': handleBoxShadowHover,
        '--z-handle-color': handleColor,
        '--z-handle-size': handleSize,
        '--z-opacity-disabled': opacityDisabled,
        '--z-rail-color': railColor,
        '--z-rail-color-hover': railColorHover,
        '--z-rail-height': railHeight,
        '--z-rail-width-vertical': railWidthVertical,
        '--z-mark-font-size': markFontSize
      }
    })
    ...
    const indicatorCssVarsRef = computed(() => {
      ...
      return {
        '--z-font-size': fontSize,
        '--z-indicator-border-radius': indicatorBorderRadius,
        '--z-indicator-box-shadow': indicatorBoxShadow,
