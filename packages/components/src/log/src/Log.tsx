...
import ZLogLoader from './LogLoader'
import ZLogLine from './LogLine'
  ...
  setup (props) {
    ...
    const cssVarsRef = computed(() => {
      ...
      return {
        ...
        '--z-loader-font-size': loaderFontSize,
        '--z-loader-border': loaderBorder,
        '--z-loader-color': loaderColor,
        '--z-loader-text-color': loaderTextColor,
    ...
    return h(
      ...
      [
                ...
                {{
                  default: () =>
                    this.mergedLines.map((line, index) => {
                      return <ZLogLine key={index} line={line} />
                    })
                }}
              </ZCode>
            )
        ...
        <Transition name="fade-in-scale-up-transition">
          {{
            default: () =>
              this.loading ? <ZLogLoader clsPrefix={mergedClsPrefix} /> : null
          }}
        </Transition>
      ]
    )
