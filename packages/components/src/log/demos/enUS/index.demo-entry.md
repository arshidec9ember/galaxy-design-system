...
<z-alert title="Note" color="warning" style="margin-bottom: 16px;" :bordered="false">
  Due to package size, Galaxy Design Components doesn't include highlight.js. If you want highlight logs, make sure you have set highlightjs before using it.
</z-alert>

In highlight demo, we defined a language called `zeta-gds-log` which will highlight all the numbers of line. The following code shows how we defined it. If you want to know more about highlight.js, see <z-a href="https://highlightjs.org/" target="_blank">highlight.js</z-a> and <z-a href="https://highlightjs.readthedocs.io/en/latest/index.html" target="_blank">highlight.js developer documentation</z-a>
...
<script>
  ...
  hljs.registerLanguage('zeta-gds-log', () => ({
    contains: [
      {
        className: 'number',
        begin: /\d+/
