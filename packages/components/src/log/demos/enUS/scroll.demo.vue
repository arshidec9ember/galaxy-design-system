...
<template>
  <z-space vertical>
    <z-button-group>
      <z-button @click="scrollTo({ position: 'bottom', silent: false })">
        Scroll To Bottom
      </z-button>
      <z-button @click="scrollTo({ position: 'bottom', silent: true })">
        Scroll To Bottom (silent)
      </z-button>
      <z-button @click="scrollTo({ position: 'top', silent: false })">
        Scroll To Top
      </z-button>
      <z-button @click="scrollTo({ position: 'top', silent: true })">
...
import { useMessage, LogInst } from '@zeta-gds/components'
