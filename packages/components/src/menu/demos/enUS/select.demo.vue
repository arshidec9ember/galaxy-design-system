...
<template>
  <z-menu :options="menuOptions" @update:model-value="handleUpdateValue" />
</template>
  ...
  setup () {
    ...
    return {
      ...
      handleUpdateValue (key: string, item: MenuOption) {
        message.info('[onUpdate:model-value]: ' + JSON.stringify(key))
        message.info('[onUpdate:model-value]: ' + JSON.stringify(item))
      }
    }
  }
})
