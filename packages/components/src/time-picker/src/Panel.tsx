...
import { ZScrollbar, ZBaseFocusDetector } from '../../_internal'
      ...
      >
        ...
        {this.actions?.length ? (
          <div class={`${mergedClsPrefix}-time-picker-actions`}>
            ...
            <div class={`${mergedClsPrefix}-time-picker-actions-right`}>
        ...
        <ZBaseFocusDetector onFocus={this.onFocusDetectorFocus} />
      </div>
    )
  }
})
